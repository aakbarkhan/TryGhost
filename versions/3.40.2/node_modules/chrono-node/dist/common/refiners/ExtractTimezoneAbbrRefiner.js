...
var ExtractTimezoneAbbrRefiner = (function () {
    function ExtractTimezoneAbbrRefiner(timezoneOverrides) {
        this.timezone = __assign(__assign({}, DEFAULT_TIMEZONE_ABBR_MAP), timezoneOverrides);
    }
    ExtractTimezoneAbbrRefiner.prototype.refine = function (context, results) {
        var timezones = __assign(__assign({}, this.timezone), context.option.timezones);
